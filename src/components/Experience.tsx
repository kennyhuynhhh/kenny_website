...
const Experience = () => {
    ...
    const [currentExperiencePhotos, setCurrentExperiencePhotos] = useState<
        string[]
    >([]);
    ...
    const experiences = [
        {
            ...
            bullets: [
                "Contribute to the code quality stream for the Editor AI team.",
                "Develop new features and agentic workflows for the modular editor component used across multiple client-facing products.",
                "Support scalability and code quality within Atlassian's largest TypeScript/React/ProseMirror frontend codebase.",
            ],
        },
        {
        ...
        },
        {
            ...
            bullets: [
                "Assigned to the DevAI-Autodev team for the Rovo Dev product.", 
                "Worked as a full-stack developer with a React, TypeScript (frontend) and Kotlin (backend) stack.",
                "Improved backend LLM integration (Claude, ChatGPT, Gemini) to improve generation efficiency.",
                "Collaborated with multiple teams of designers and AI researchers to ship production-level features.",
                "Enhanced internal developer dashboards by adding features, refining UI flows and optimising component performance.",
            ],
            photos: [
        ...
        {
            role: "Artificial Intelligence Trainer & Programmer",
            company: "Scale AI",
            location: "San Francisco (Remote)",
            period: "Dec 2023 – Mar 2024",
            bullets: [
                "Contributed to the Bulba ICE and Dolphin Coding Projects for LLM development.",
                "Evaluated Python code outputs for correctness, efficiency and accuracy.",
                "Devised solutions to abstract, multi-disciplinary problems to benchmark model reasoning.",
            ],
        },
        {
                                            ...
                                            <div className="flex items-start mb-1">
                                                ...
                                                >
                                                    <div className="flex items-center gap-3">
                                                        <h3 className="text-xl font-medium primary-text m-0 p-0">
                                                            {exp.role}
                                                        </h3>
                                                        {exp.photos && exp.photos.length > 0 && (
                                                            <button
                                                                ...
                                                                title={`View ${exp.photos.length} photo${
                                                                    exp.photos.length > 1 ? "s" : ""
                                                                }`}
                                                            >
                                                                <svg
                                                                    className="w-6"
                                                    ...
                                                    <span className="text-lg primary-text font-medium m-0 p-0">
                                                        {exp.company}
                                                    </span>
                                                    <span className="text-lg primary-text font-normal m-0 p-0">
                                                        {" "}
                                                        - {exp.location}
                                                    </span>
                                                </div>
                                                <div
                                                    className="text-sm primary-text mb-2"
                                                    style={{
                                                        whiteSpace: "nowrap",
                                                        textAlign: "right",
                                                        marginTop: "2px",
