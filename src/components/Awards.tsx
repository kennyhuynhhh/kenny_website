...
const Awards = () => {
	const awards = [
		{
			title: "Vice-Chancellor's List Recipient",
			organization: "Curtin University",
			issuer: "Professor Harlene Hayne, Vice-Chancellor",
			date: "Feb 2025",
			description:
				"Attained membership of the Vice-Chancellor's List in the 3rd year of my degree, awarded to the top 1% of students in the course (94.25% SWA)",
		...
		},
		{
			...
			date: "May 2023",
			description:
				"Recipient of the Toussaint & Richardson Scholarship awarded on the basis of academic excellence (90.75% CWA)",
			type: "scholarship",
		},
		{
			...
			date: "2022-2025",
			description:
				"The Faculty of Science and Engineering commends me for my academic performance in my units in 2023, 2024 and 2025.",
